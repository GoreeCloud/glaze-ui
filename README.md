...
- `GLAZE_UI_2.md` / `tokens/glaze-2.candidate.json` — immutable Candidate promotion-source evidence.
...
The pull-request workflow validates the **exact candidate revision** and remains authoritative. Core commands include:
