...
- `wear-os/MainActivity.kt` plus `wear-os/buildable/` — minimal reproducible Android application harness for compiling the same reference composable against a pinned current toolchain: AGP 9.3.0, Kotlin Compose plugin 2.3.21, compileSdk 37, Compose BOM 2026.08.00, Wear Compose Material 3 1.5.0, and verified Gradle 9.5.0.
