# Glaze UI Identity Concepts — Round 01

Status: **Review candidates only — not approved, canonical, deployable, or public-site artwork.**
...
- strongest connection to Glaze UI surface hierarchy;
- distinctive asymmetrical silhouette;
- whether the central aperture remains legible at 16–24 px;
- whether the layered construction feels original rather than app-icon generic.

## Candidate 02 — Flow Bands
...
- strongest motion/fluidity concept of this round;
- simplest small-size silhouette;
- whether the bands remain recognizably Glaze UI rather than becoming a generic wave/network symbol;
- monochrome separation of the three bands.
...
- strongest structural/system concept of this round;
- compact geometric silhouette;
- whether the center reads intentionally at favicon sizes;
- whether the mark is too architectural or sufficiently fluid for Glaze UI.
