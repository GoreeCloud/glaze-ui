...
Glaze UI 1.3.0 is the stable GoreeCloud design system. Its public design site currently uses a text-first identity. No icon, logo, favicon, or product mark is approved as canonical Glaze UI artwork at this time.
