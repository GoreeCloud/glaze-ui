...
assert(lifecycle.activeCandidate === null || lifecycle.activeCandidate === '1.6.0-rc.1', 'V1.5.1 Stable may coexist only with the governed V1.6.0-rc.1 next-version candidate');
