...
def main() -> None:
    ...
    req(stable[0].get("promotedFromCandidate") == "1.0.0", "2.2 Stable promotion-source Candidate missing")
    ...
    candidate = [r for r in releases if isinstance(r, dict) and r.get("version") == "1.0.0"]
    ...
    for path in ("GLAZE_UI_V1_STABLE.md", "acceptance/2.2-stable.md", "css/glaze-v1.0.css", "js/glaze-v1.0.mjs"):
    ...
    print("GLAZE UI V1.0 canonical release state validated; downstream consumers remain separately gated")
