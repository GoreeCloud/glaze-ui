...
require(stable == "1.5.1", f"expected current Stable 1.5.1, found {stable}")
...
require(contract.get("stableBaseline") == stable, "Development contract must identify the live Stable baseline")
require(tokens.get("stableBaseline") == stable, "Development token map must identify the live Stable baseline")
