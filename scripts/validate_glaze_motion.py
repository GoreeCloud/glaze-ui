#!/usr/bin/env python3
"""Fail-closed governance validation for Glaze Motion 0.6 Experimental under current Stable Glaze UI."""
...
def main():
    ...
    # the canonical consumer registry is allowed to advance independently through
    # evidence-backed current-Stable adoption. Stable adoption must not imply a
    # Glaze Motion production dependency or production eligibility.
    ...
    req(keyboard.get('targetVersion')=='2.2.0' and keyboard.get('requiredTargetVersion')=='2.2.0','Keyboard must target current Stable 2.2.0')
    req(keyboard.get('referenceRevision')==KEYBOARD_CURRENT_ADOPTION and keyboard.get('evidence')=='docs/glaze-ui-adoption.md','Keyboard current Stable adoption evidence changed')
    ...
    print('Glaze Motion 0.6 Experimental validated under Glaze UI 2.2 Stable: historical Motion evaluations preserved; Launcher and Keyboard may advance through Stable adoption without Motion production authority')
