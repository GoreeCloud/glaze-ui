...
Glaze UI 1.4.0 is the current Stable baseline. Existing consumers may remain on older Stable versions until an intentional, evidence-backed migration is justified.

## 1. Record the target version
Record semantic version, reviewed canonical source revision, repository-local evidence, automated contract, and product-specific acceptance boundary.
...
Validate the subset actually consumed: semantic tokens, states, material boundaries, accessibility fallbacks, form-factor activation, and directional focus where applicable.

## 12. Perform visual acceptance
Representative supported profiles: Mobile 390×844; Tablet 820×1180; Desktop 1280×900; Wide Desktop 1600×1000; TV 1920×1080. Review task flows, not screenshots alone.

## Platform-native clients
Native Android, iOS/iPadOS/tvOS, Linux, desktop, or other implementations map Glaze semantics into platform-native controls, focus systems, density units, safe areas, windowing, and accessibility. Design-system 1.4 stability does not waive application-specific native or real-device acceptance.
