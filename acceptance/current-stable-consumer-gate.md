...
The reusable workflow is enforcement infrastructure only. Each consumer must still create its own repository-local manifest and evidence and pass the gate on that consumer's own source revision.
