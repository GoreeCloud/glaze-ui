...
14. **Product personality** — applications may vary composition, accent emphasis, imagery, information architecture, visualization, and specialized components while retaining the Glaze contract.
...
16. **Visual acceptance** — light and dark modes are reviewed visually at representative phone/Compact, tablet/Medium, desktop/Expanded, and Wide layouts for every supported target before stable release; products with native clients also require representative real-client acceptance.
