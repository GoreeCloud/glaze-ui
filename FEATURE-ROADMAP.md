...
| FR-015 | Expand V1.6 beyond loading into the full semantic state grammar, accessibility profiles, focus, motion families, materials, typography, density, responsive behavior, recovery, diagnostics, and conformance metadata. | P0 | Partial Development implementation now covers sections 6–93 except section 5: component/state/accessibility; materials/type/input; resilience; search/navigation/responsive/status; complexity/energy/component systems; progressive disclosure/action hierarchy/application familiarity; token safety; truthful/privacy-minimized/local-first adaptation; stable primary actions; calm defaults; restrained expressive effects; and developer/accessibility/skeleton diagnostics plus visual/semantic/performance/layout regression and graceful degradation. Section 5 perceived-performance integration, sections 94–97 consistency/conformance/adoption/migration work, section 98 acceptance evidence, and governed lifecycle/application adoption remain open. |
| FR-016 | Build the V1.6 section 98 acceptance matrix, including accessibility, representative rendering, layout stability, performance, offline/degraded behavior, privacy/authority boundaries, and regression coverage. | P0 | Pending; source validators now cover loading plus state/accessibility/performance invariants, but Development machine checks do not constitute rendered/native/human/device/performance acceptance. |
