...
| FR-015 | Expand V1.6 beyond loading into the full semantic state grammar, accessibility profiles, focus, motion families, materials, typography, density, responsive behavior, recovery, diagnostics, and conformance metadata. | P0 | Partial Development implementation now covers sections 6–73 except section 5: semantic state/accessibility/performance; focus/motion; material/type/density/input; resilience/feedback; search/navigation/responsive/status; visual-complexity and energy budgets; reusable-component state/composition rules; forms/save feedback; tables/charts/media/scroll/background activity; and state/content continuity. Section 5 perceived-performance integration, sections 74–97 broader component/diagnostic/conformance/adoption work, section 98 acceptance evidence, and lifecycle/application adoption remain open. |
