...
| FR-015 | Expand V1.6 beyond loading into the full semantic state grammar, accessibility profiles, focus, motion families, materials, typography, density, responsive behavior, recovery, diagnostics, and conformance metadata. | P0 | Partial Development implementation now covers sections 6–40, 55–59, and 71–73: semantic state/accessibility/performance; unified focus/motion; material/type/density/input; and reason-specific empty/error/recovery/offline/stale/optimistic/progress/notification/dialog/destructive-action presentation. Search/navigation/responsive/pane/posture/localization, status/badge/provenance/privacy/security presentation expansion, energy/complexity budgets, component systems, broader diagnostics/conformance metadata, and acceptance work remain open. |
