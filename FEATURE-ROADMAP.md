...
| FR-016 | Build the V1.6 section 98 acceptance matrix, including accessibility, representative rendering, layout stability, performance, offline/degraded behavior, privacy/authority boundaries, and regression coverage. | P0 | Grouped 24-lane matrix is implemented against frozen revision `c7509c79256b04b0aa67cb9dd0737d7588e0ae4a`. Machine run `35345027816`, rendered-browser run `35348330585`, and rendered-regression run `35352215130` now verify 17 lanes; 7 remain unverified. Remaining partial lanes are Accessibility, Keyboard navigation, Privacy boundaries, Authority boundaries, and Representative rendering; Assistive technology and Performance have no qualifying evidence yet. The representative-performance control plane is implemented, but hosted CI is non-representative and the Performance lane remains open until real reviewed measurements are durably accepted. |
