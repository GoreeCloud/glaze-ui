...
| FR-015 | Expand V1.6 beyond loading into the full semantic state grammar, accessibility profiles, focus, motion families, materials, typography, density, responsive behavior, recovery, diagnostics, and conformance metadata. | P0 | Partial Development implementation now covers sections 6–79, 88–93, and prior continuity/performance foundations: component/state/accessibility; materials/type/input; resilience; search/navigation/responsive/status; complexity/energy/component systems; progressive disclosure/action hierarchy/application familiarity; token safety; truthful/privacy-minimized/local-first adaptation; stable primary actions; calm defaults; and restrained expressive effects. Section 5 perceived-performance integration, sections 80–87 diagnostics/regression/degradation work, sections 94–97 consistency/conformance/adoption/migration work, section 98 acceptance evidence, and governed lifecycle/application adoption remain open. |
