...
| FR-015 | Expand V1.6 beyond loading into the full semantic state grammar, accessibility profiles, focus, motion families, materials, typography, density, responsive behavior, recovery, diagnostics, and conformance metadata. | P0 | Partial Development implementation now covers sections 6–14, 55–59, and 71–73 across semantic state/accessibility/performance plus unified focus, 17 motion families, motion hierarchy/interruptibility/fatigue budgets, microinteractions, state continuity, and content transitions. Materials, typography, density, input-aware interaction, responsive/recovery, broader component systems, and conformance metadata remain open. |
