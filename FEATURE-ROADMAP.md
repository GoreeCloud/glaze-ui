...
| FR-015 | Expand V1.6 beyond loading into the full semantic state grammar, accessibility profiles, focus, motion families, materials, typography, density, responsive behavior, recovery, diagnostics, and conformance metadata. | P0 | Partial Development implementation now covers sections 6–28, 55–59, and 71–73: semantic state/accessibility/performance; unified focus/motion; material/transparency/blur/depth boundaries; semantic typography/large-text resilience; density/target protection; and input/hover/press/tactile intent. Empty/error/recovery/offline/search/navigation/responsive/component systems, broader diagnostics/conformance metadata, and acceptance work remain open. |
