...
| FR-015 | Expand V1.6 beyond loading into the full semantic state grammar, accessibility profiles, focus, motion families, materials, typography, density, responsive behavior, recovery, diagnostics, and conformance metadata. | P0 | Partial Development implementation now covers sections 6–59 and 71–73: semantic state/accessibility/performance; unified focus/motion; material/type/density/input; resilience/feedback; and search/navigation/responsive/pane/posture/localization/icon/status/badge/provenance/privacy/security/capability presentation. Section 5 perceived-performance integration, energy/complexity budgets, component-state completeness, forms/tables/charts/media/scroll/background-work systems, broader diagnostics/conformance metadata, acceptance evidence, and application adoption work remain open. |
