...
| FR-015 | Expand V1.6 beyond loading into the full semantic state grammar, accessibility profiles, focus, motion families, materials, typography, density, responsive behavior, recovery, diagnostics, and conformance metadata. | P0 | Partial Development implementation: sections 6–9 and 55–59 now have semantic-state, accessibility-profile, capability-distinction, performance-level, explainable-diagnostic, and anti-jitter runtime/contracts/tokens. Focus, broader motion families, materials, typography, density, responsive/recovery, and conformance-metadata work remains open. |
