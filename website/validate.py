...
required_dist = ["index.html", "404.html", "_headers", "assets/glaze.css", "assets/glaze.accessibility.css", "assets/site.css", "assets/site.js"]
...
for needle in ["Glaze UI 1.1.0", "Canvas", "Solid", "Raised", "Glaze", "Overlay", "Eleven gates", "Skip to content"]:
